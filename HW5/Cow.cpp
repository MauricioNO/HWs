...
Cow::Cow(int pos_x, int pos_y, int c_starveTime, int c_reprodRate) : Creature(pos_x, pos_y, Constants::cow_width, Constants::cow_height, "black", c_starveTime, c_reprodRate)
{
	Ctype = COW;
	movSpeed = 1;
	hungriness = Constants::cow_maxHunger;
	vision = 300;
	deathAge = 2000;
	maxHunger = Constants::cow_maxHunger;
	Cterrain = LAND;
}
